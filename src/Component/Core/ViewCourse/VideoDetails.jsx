                      ...
                      <div className='flex justify-center items-center'>
                        {
                          !completedLectures.includes(videoData._id) && (
                            <IconBtn disabled={loading} onClickHandler={() => { handleLectureCompletion() }} text={!loading ? "Mark as Completed":"Loading..."} customClasses='bg-yellow-100 text-richblack-900 absolute top-[20%] hover:scale-90 z-20 font-medium md:text-sm px-4 py-2 rounded-md'/>
                          )
                        }
                      </div>
                      {
